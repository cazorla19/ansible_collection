...
-- start admin console
console.listen("0.0.0.0:{{ environments['portfolio_dev'].console_port }}")

tarantool_user = '{{ environments['portfolio_dev'].user }}'
tarantool_password = '{{ environments['portfolio_dev'].password }}'
tarantool_port = '{{ environments['portfolio_dev'].port }}'
