...
-- start admin console
console.listen('0.0.0.0:{{ environments['portfolio_production'].console_port }}')

tarantool_user = '{{ environments['portfolio_production'].user }}'
tarantool_password = '{{ environments['portfolio_production'].password }}'
tarantool_port = '{{ environments['portfolio_production'].port }}'
